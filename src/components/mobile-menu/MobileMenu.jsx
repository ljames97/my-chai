...
const MobileMenu = ({ toggleMobileMenu, toggleLoginModal }) => {
  ...
  return (
    <div className="modal mobile-menu">
      <div className={styles['mobile-menu-header']}>
        <svg onClick={toggleLoginModal} id='profile-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
