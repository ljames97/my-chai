  ...
  return (
    <div className="modal mobile-menu">
      <div className={`${styles['mobile-menu-header']} ${isDarkMode ? styles['dark'] : ''}`}>
        ...
        <button onClick={handleThemeSwitch} className={`${styles['theme-switch-btn']} ${isDarkMode ? styles['dark'] : ''}`}>{isDarkMode ? 'Light mode' : 'Dark mode'}</button>
        <button className={`${isDarkMode ? 'dark' : ''} exit-modal-btn`} onClick={toggleMobileMenu}>X</button>
      </div>
      ...
      <ul className={`${styles['mobile-menu-items']} ${isDarkMode ? styles['dark']: ''}`}>
        <li onClick={toggleMobileMenu} className={`${styles['mobile-menu-item']} ${isDarkMode ? styles['dark'] : ''}`}>
